...
class Hero{
	...
	renderImg(){
		return `<img src="./images/${this.image}" alt="${this.name}" height="75 px">`;
	}
	...
	btnEvent(){
		alert(`Hello! My name is ${this.name}! My friends are ${this.friends.join(', ')}!`);
	}
}

export let Winnie = new Hero('task-10');